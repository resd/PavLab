...
% Last Modified by GUIDE v2.5 26-Apr-2015 18:42:45
...
switch v1
    case 1% PP
        ...
        switch v2
            case 1%msr
                [res, outf] = Am(cl1tt, cl2tt, col, t1);% todo col
            case 2%msa
            case 3%ns
        end
        if(len == 2)
...
%         end
    ...
    otherwise% Читаем введенные данные и на их основании выводим результат
        ...
        switch v2
            case 1% MSR
                [res1, a] = rule_lab2_1(cl1t, cl2t);%todo add pr
...
%                 MSA(cl1t, cl2t, length(t1));
                [res1, a, c1max] = MSAold2(cl1t, cl2t, length(t1), 1);
                ...
                out % for Ivan
            case 3% MSA + MSR
                [res1, a, c1max] = MSAold2(cl1t, cl2t, length(t1), 2);
                %[res2, outf, c2, c2max] = MSAnew(cl1t, cl2t, length(t1), 2);
