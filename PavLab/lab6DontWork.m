...
net.trainParam.epochs = 1000;    %врема обучениа сети
...
legend('»сходное значение 1 класса дл€ 1 признака', '»сходное значение 1 класса дл€ 2 признака',...
    'Ќайденное значение 1 класса дл€ 1 признака', 'Ќайденное значение 1 класса дл€ 2 признака', 'ƒопустимый диапазон погрешности');
figure(2);
hold on;
title('Class 2');
...
legend('»сходное значение 2 класса дл€ 1 признака', '»сходное значение 2 класса дл€ 2 признака',...
        'Ќайденное значение 2 класса дл€ 1 признака', 'Ќайденное значение 2 класса дл€ 2 признака', 'ƒопустимый диапазон погрешности');
% close(1); % del
% close(2); % del
