function varargout = dataCreate(varargin)
% DATACREATE M-file for dataCreate.fig
%      DATACREATE, by itself, creates a new DATACREATE or raises the existing
%      singleton*.
%
%      H = DATACREATE returns the handle to a new DATACREATE or the handle to
%      the existing singleton*.
%
%      DATACREATE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DATACREATE.M with the given input arguments.
%
%      DATACREATE('Property','Value',...) creates a new DATACREATE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dataCreate_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dataCreate_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @dataCreate_OpeningFcn, ...
                   'gui_OutputFcn',  @dataCreate_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% varargin   command line arguments to dataCreate (see VARARGIN)

% Choose default command line output for dataCreate
